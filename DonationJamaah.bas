...
Private Sub CreateItem(Width As Int, id As String, Title As String, needed As String, collect As String, worship As String) As Panel
				...
				Try
					...
					If data.Size-1 > 0 Then
						...
						For i=0 To data.Size -1
							...
							CLV.Add(CreateItem(CLV.AsView.Width,a.Get("id"),a.Get("name"),"Fund Needed : "&a.Get("fund"),"Fund Collected : "&a.Get("fund_collected"),"Worship Place : "&a.Get("worship")),"")
