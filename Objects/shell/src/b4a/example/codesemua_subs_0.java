...
try {
		Debug.PushSubsStack("ExecuteUrl (codesemua) ","codesemua",12,_ba,codesemua.mostCurrent,21);
...
try {
		Debug.PushSubsStack("ExecuteUrlGet (codesemua) ","codesemua",12,_ba,codesemua.mostCurrent,27);
...
try {
		Debug.PushSubsStack("SetBackgroundTintList (codesemua) ","codesemua",12,_ba,codesemua.mostCurrent,9);
...
try {
		Debug.PushSubsStack("SetCBDrawable (codesemua) ","codesemua",12,_ba,codesemua.mostCurrent,33);
