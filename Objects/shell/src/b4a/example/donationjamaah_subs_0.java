...
try {
		Debug.PushSubsStack("Activity_Create (donationjamaah) ","donationjamaah",5,donationjamaah.mostCurrent.activityBA,donationjamaah.mostCurrent,30);
...
try {
		Debug.PushSubsStack("Activity_Pause (donationjamaah) ","donationjamaah",5,donationjamaah.mostCurrent.activityBA,donationjamaah.mostCurrent,47);
...
try {
		Debug.PushSubsStack("Activity_Resume (donationjamaah) ","donationjamaah",5,donationjamaah.mostCurrent.activityBA,donationjamaah.mostCurrent,42);
...
try {
		Debug.PushSubsStack("CLV_ItemClick (donationjamaah) ","donationjamaah",5,donationjamaah.mostCurrent.activityBA,donationjamaah.mostCurrent,110);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 110;BA.debugLine="Sub CLV_ItemClick (Index As Int, Value As Object)";
Debug.ShouldStop(8192);
 BA.debugLineNum = 111;BA.debugLine="StartActivity(DonationJamaahDetail)";
Debug.ShouldStop(16384);
...
public static RemoteObject  _createitem(RemoteObject _width,RemoteObject _id,RemoteObject _title,RemoteObject _needed,RemoteObject _collect,RemoteObject _worship) throws Exception{
try {
		Debug.PushSubsStack("CreateItem (donationjamaah) ","donationjamaah",5,donationjamaah.mostCurrent.activityBA,donationjamaah.mostCurrent,51);
if (RapidSub.canDelegate("createitem")) return b4a.example.donationjamaah.remoteMe.runUserSub(false, "donationjamaah","createitem", _width, _id, _title, _needed, _collect, _worship);
...
try {
		Debug.PushSubsStack("JobDone (donationjamaah) ","donationjamaah",5,donationjamaah.mostCurrent.activityBA,donationjamaah.mostCurrent,66);
...
_res = _job.runMethod(true,"_getstring");Debug.locals.put("res", _res);
 BA.debugLineNum = 72;BA.debugLine="Dim parser As JSONParser 'mengambil data dalam b";
Debug.ShouldStop(128);
...
if (RemoteObject.solveBoolean(">",RemoteObject.solve(new RemoteObject[] {_data.runMethod(true,"getSize"),RemoteObject.createImmutable(1)}, "-",1, 1),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 83;BA.debugLine="For i=0 To data.Size -1";
Debug.ShouldStop(262144);
{
final int step12 = 1;
...
;
 BA.debugLineNum = 91;BA.debugLine="PanelQurban.Height= CLV.AsView.Height + 10%y";
Debug.ShouldStop(67108864);
donationjamaah.mostCurrent._panelqurban.runMethod(true,"setHeight",RemoteObject.solve(new RemoteObject[] {donationjamaah.mostCurrent._clv.runMethod(false,"_asview").runMethod(true,"getHeight"),donationjamaah.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 10)),donationjamaah.mostCurrent.activityBA)}, "+",1, 1));
 BA.debugLineNum = 92;BA.debugLine="CLV.sv.Height = CLV.AsView.Height";
Debug.ShouldStop(134217728);
donationjamaah.mostCurrent._clv.getField(false,"_sv").runMethod(true,"setHeight",donationjamaah.mostCurrent._clv.runMethod(false,"_asview").runMethod(true,"getHeight"));
 BA.debugLineNum = 93;BA.debugLine="CLV.AsView.Height = CLV.AsView.Height";
Debug.ShouldStop(268435456);
donationjamaah.mostCurrent._clv.runMethod(false,"_asview").runMethod(true,"setHeight",donationjamaah.mostCurrent._clv.runMethod(false,"_asview").runMethod(true,"getHeight"));
 BA.debugLineNum = 94;BA.debugLine="MainScroll.Panel.Height = PanelQurban.Height";
Debug.ShouldStop(536870912);
donationjamaah.mostCurrent._mainscroll.runMethod(false,"getPanel").runMethod(true,"setHeight",donationjamaah.mostCurrent._panelqurban.runMethod(true,"getHeight"));
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",donationjamaah.processBA, e24.toString()); BA.debugLineNum = 99;BA.debugLine="Log(LastException)";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("PanelListItem_Click (donationjamaah) ","donationjamaah",5,donationjamaah.mostCurrent.activityBA,donationjamaah.mostCurrent,114);
...
RemoteObject _a = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
 BA.debugLineNum = 114;BA.debugLine="Sub PanelListItem_Click";
Debug.ShouldStop(131072);
 BA.debugLineNum = 115;BA.debugLine="Dim item As Int = CLV.GetItemFromView(Sender)";
Debug.ShouldStop(262144);
...
donationjamaah._idselected = _a.runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 0))).runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 5))).runMethod(true,"getText");
 BA.debugLineNum = 128;BA.debugLine="StartActivity(DonationJamaahDetail)";
Debug.ShouldStop(-2147483648);
donationjamaah.mostCurrent.__c.runVoidMethod ("StartActivity",donationjamaah.processBA,(Object)((donationjamaah.mostCurrent._donationjamaahdetail.getObject())));
