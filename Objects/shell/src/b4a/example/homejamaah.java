...
public static b4a.example.poorjamaah _poorjamaah = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",homejamaah.mostCurrent._activity,"address",homejamaah._address,"avatar",homejamaah._avatar,"BackBtn",homejamaah.mostCurrent._backbtn,"CodeSemua",Debug.moduleToString(b4a.example.codesemua.class),"constructionBtn",homejamaah.mostCurrent._constructionbtn,"DonationJamaah",Debug.moduleToString(b4a.example.donationjamaah.class),"DonationJamaahConfirm",Debug.moduleToString(b4a.example.donationjamaahconfirm.class),"DonationJamaahDetail",Debug.moduleToString(b4a.example.donationjamaahdetail.class),"historyBtn",homejamaah.mostCurrent._historybtn,"HistoryJamaah",Debug.moduleToString(b4a.example.historyjamaah.class),"historyLabel",homejamaah.mostCurrent._historylabel,"HomeStewardship",Debug.moduleToString(b4a.example.homestewardship.class),"HttpUtils2Service",homejamaah.mostCurrent._httputils2service,"id",homejamaah._id,"LabelName",homejamaah.mostCurrent._labelname,"LabelNumber",homejamaah.mostCurrent._labelnumber,"LabelUser",homejamaah.mostCurrent._labeluser,"logoutBtn",homejamaah.mostCurrent._logoutbtn,"logoutLabel",homejamaah.mostCurrent._logoutlabel,"Main",Debug.moduleToString(b4a.example.main.class),"MainScroll",homejamaah.mostCurrent._mainscroll,"mapBtn",homejamaah.mostCurrent._mapbtn,"MapsJamaah",Debug.moduleToString(b4a.example.mapsjamaah.class),"Navbar",homejamaah.mostCurrent._navbar,"NavbarTitle",homejamaah.mostCurrent._navbartitle,"orphanBtn",homejamaah.mostCurrent._orphanbtn,"OrphansJamaah",Debug.moduleToString(b4a.example.orphansjamaah.class),"OrphansJamaahDetail",Debug.moduleToString(b4a.example.orphansjamaahdetail.class),"PanelBanner",homejamaah.mostCurrent._panelbanner,"PanelHome",homejamaah.mostCurrent._panelhome,"PanelMenu",homejamaah.mostCurrent._panelmenu,"PanelPhoto",homejamaah.mostCurrent._panelphoto,"phone",homejamaah._phone,"poorBtn",homejamaah.mostCurrent._poorbtn,"PoorJamaah",Debug.moduleToString(b4a.example.poorjamaah.class),"PoorJamaahDetail",Debug.moduleToString(b4a.example.poorjamaahdetail.class),"qurbanBtn",homejamaah.mostCurrent._qurbanbtn,"QurbanJamaah",Debug.moduleToString(b4a.example.qurbanjamaah.class),"QurbanJamaahConfirm",Debug.moduleToString(b4a.example.qurbanjamaahconfirm.class),"QurbanJamaahDetail",Debug.moduleToString(b4a.example.qurbanjamaahdetail.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"status",homejamaah._status,"StewardshipDonationDetail",Debug.moduleToString(b4a.example.stewardshipdonationdetail.class),"tpaBtn",homejamaah.mostCurrent._tpabtn,"TpaJamaah",Debug.moduleToString(b4a.example.tpajamaah.class),"TpaJamaahDetail",Debug.moduleToString(b4a.example.tpajamaahdetail.class),"types",homejamaah._types,"updated_at",homejamaah._updated_at,"username",homejamaah._username,"worship_name",homejamaah._worship_name,"worship_place_address",homejamaah._worship_place_address};
}
}