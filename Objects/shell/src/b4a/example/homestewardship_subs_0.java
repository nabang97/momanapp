...
try {
		Debug.PushSubsStack("Activity_Create (homestewardship) ","homestewardship",13,homestewardship.mostCurrent.activityBA,homestewardship.mostCurrent,18);
...
try {
		Debug.PushSubsStack("Activity_Pause (homestewardship) ","homestewardship",13,homestewardship.mostCurrent.activityBA,homestewardship.mostCurrent,28);
...
try {
		Debug.PushSubsStack("Activity_Resume (homestewardship) ","homestewardship",13,homestewardship.mostCurrent.activityBA,homestewardship.mostCurrent,24);
