...
public static b4a.example.poorjamaah _poorjamaah = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"address",main._address,"avatar",main._avatar,"BtnLogin",main.mostCurrent._btnlogin,"CodeSemua",Debug.moduleToString(b4a.example.codesemua.class),"DonationJamaah",Debug.moduleToString(b4a.example.donationjamaah.class),"DonationJamaahConfirm",Debug.moduleToString(b4a.example.donationjamaahconfirm.class),"DonationJamaahDetail",Debug.moduleToString(b4a.example.donationjamaahdetail.class),"EditPassword",main.mostCurrent._editpassword,"EditUsername",main.mostCurrent._editusername,"HistoryJamaah",Debug.moduleToString(b4a.example.historyjamaah.class),"HomeJamaah",Debug.moduleToString(b4a.example.homejamaah.class),"HomeStewardship",Debug.moduleToString(b4a.example.homestewardship.class),"HttpUtils2Service",main.mostCurrent._httputils2service,"id",main._id,"labeljam",main.mostCurrent._labeljam,"Labelstep",main.mostCurrent._labelstep,"MainScroll",main.mostCurrent._mainscroll,"manager",main._manager,"MapsJamaah",Debug.moduleToString(b4a.example.mapsjamaah.class),"md5string",main.mostCurrent._md5string,"Navbar",main.mostCurrent._navbar,"OrphansJamaah",Debug.moduleToString(b4a.example.orphansjamaah.class),"OrphansJamaahDetail",Debug.moduleToString(b4a.example.orphansjamaahdetail.class),"PanelLogin",main.mostCurrent._panellogin,"phone",main._phone,"pjam",main.mostCurrent._pjam,"PoorJamaah",Debug.moduleToString(b4a.example.poorjamaah.class),"PoorJamaahDetail",Debug.moduleToString(b4a.example.poorjamaahdetail.class),"pstep",main.mostCurrent._pstep,"QurbanJamaah",Debug.moduleToString(b4a.example.qurbanjamaah.class),"QurbanJamaahConfirm",Debug.moduleToString(b4a.example.qurbanjamaahconfirm.class),"QurbanJamaahDetail",Debug.moduleToString(b4a.example.qurbanjamaahdetail.class),"server",main._server,"Starter",Debug.moduleToString(b4a.example.starter.class),"status",main._status,"StewardshipDonationDetail",Debug.moduleToString(b4a.example.stewardshipdonationdetail.class),"TpaJamaah",Debug.moduleToString(b4a.example.tpajamaah.class),"TpaJamaahDetail",Debug.moduleToString(b4a.example.tpajamaahdetail.class),"types",main._types,"updated_at",main._updated_at,"username",main._username,"worship_name",main._worship_name,"worship_place_address",main._worship_place_address};
}
}