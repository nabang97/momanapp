...
try {
		Debug.PushSubsStack("BtnLogin_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,141);
...
RemoteObject _passwordhash = null;
 BA.debugLineNum = 141;BA.debugLine="Sub BtnLogin_Click";
Debug.ShouldStop(4096);
 BA.debugLineNum = 142;BA.debugLine="Private pi As String";
Debug.ShouldStop(8192);
_pi = RemoteObject.createImmutable("");Debug.locals.put("pi", _pi);
 BA.debugLineNum = 143;BA.debugLine="pi = EditPassword.Text";
Debug.ShouldStop(16384);
_pi = main.mostCurrent._editpassword.runMethod(true,"getText");Debug.locals.put("pi", _pi);
 BA.debugLineNum = 145;BA.debugLine="Dim md As MessageDigest";
...
_md = RemoteObject.createNew ("anywheresoftware.b4a.agraham.encryption.CipherWrapper.MessageDigestWrapper");Debug.locals.put("md", _md);
 BA.debugLineNum = 146;BA.debugLine="Dim ByteCon As ByteConverter";
Debug.ShouldStop(131072);
_bytecon = RemoteObject.createNew ("anywheresoftware.b4a.agraham.byteconverter.ByteConverter");Debug.locals.put("ByteCon", _bytecon);
 BA.debugLineNum = 147;BA.debugLine="Dim passwordhash() As Byte";
Debug.ShouldStop(262144);
_passwordhash = RemoteObject.createNewArray ("byte", new int[] {0}, new Object[]{});Debug.locals.put("passwordhash", _passwordhash);
 BA.debugLineNum = 149;BA.debugLine="passwordhash = md.GetMessageDigest(pi.GetBytes(\"U";
...
_passwordhash = _md.runMethod(false,"GetMessageDigest",(Object)(_pi.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))),(Object)(RemoteObject.createImmutable("MD5")));Debug.locals.put("passwordhash", _passwordhash);
 BA.debugLineNum = 150;BA.debugLine="md5string = ByteCon.HexFromBytes(passwordhash)";
Debug.ShouldStop(2097152);
main.mostCurrent._md5string = _bytecon.runMethod(true,"HexFromBytes",(Object)(_passwordhash));
 BA.debugLineNum = 151;BA.debugLine="md5string = md5string.ToLowerCase";
Debug.ShouldStop(4194304);
main.mostCurrent._md5string = main.mostCurrent._md5string.runMethod(true,"toLowerCase");
 BA.debugLineNum = 152;BA.debugLine="CodeSemua.ExecuteUrl(server&\"api/login\",\"phone=\"&";
Debug.ShouldStop(8388608);
main.mostCurrent._codesemua.runVoidMethod ("_executeurl",main.mostCurrent.activityBA,(Object)(RemoteObject.concat(main._server,RemoteObject.createImmutable("api/login"))),(Object)(RemoteObject.concat(RemoteObject.createImmutable("phone="),main.mostCurrent._editusername.runMethod(true,"getText"),RemoteObject.createImmutable("&password="),main.mostCurrent._md5string)),(Object)(BA.ObjectToString("Login")),(Object)(main.getObject()));
...
try {
		Debug.PushSubsStack("CheckLogin (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,172);
...
RemoteObject _islogin = RemoteObject.createImmutable(false);
 BA.debugLineNum = 172;BA.debugLine="Sub CheckLogin";
Debug.ShouldStop(2048);
 BA.debugLineNum = 173;BA.debugLine="Dim islogin As Boolean";
Debug.ShouldStop(4096);
_islogin = RemoteObject.createImmutable(false);Debug.locals.put("islogin", _islogin);
 BA.debugLineNum = 174;BA.debugLine="islogin = manager.GetBoolean(\"is_login\")";
Debug.ShouldStop(8192);
_islogin = main._manager.runMethod(true,"GetBoolean",(Object)(RemoteObject.createImmutable("is_login")));Debug.locals.put("islogin", _islogin);
 BA.debugLineNum = 175;BA.debugLine="If islogin Then";
Debug.ShouldStop(16384);
if (_islogin.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 176;BA.debugLine="If manager.GetBoolean(\"jamaah\") = True Then";
Debug.ShouldStop(32768);
...
main.mostCurrent._activity.runVoidMethod ("Finish");
 BA.debugLineNum = 178;BA.debugLine="StartActivity(HomeJamaah)";
Debug.ShouldStop(131072);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((main.mostCurrent._homejamaah.getObject())));
 }else {
 BA.debugLineNum = 180;BA.debugLine="If manager.GetBoolean(\"step\") = True Then";
...
Debug.ShouldStop(1048576);
main.mostCurrent._activity.runVoidMethod ("Finish");
 BA.debugLineNum = 182;BA.debugLine="StartActivity(HomeStewardship)";
Debug.ShouldStop(2097152);
...
main._id = BA.ObjectToString(_a.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("jamaah_id")))));
 BA.debugLineNum = 93;BA.debugLine="worship_name = a.Get(\"worship_name\")";
Debug.ShouldStop(268435456);
main._worship_name = BA.ObjectToString(_a.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("worship_name")))));
 BA.debugLineNum = 94;BA.debugLine="types= a.Get(\"types\")";
Debug.ShouldStop(536870912);
main._types = BA.ObjectToString(_a.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("types")))));
...
main._address = BA.ObjectToString(_a.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("address")))));
 BA.debugLineNum = 96;BA.debugLine="updated_at= a.Get(\"updated_at\")";
Debug.ShouldStop(-2147483648);
main._updated_at = BA.ObjectToString(_a.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("updated_at")))));
...
main._avatar = BA.ObjectToString(_a.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("avatar")))));
 BA.debugLineNum = 98;BA.debugLine="worship_place_address= a.Get(\"worship_place_a";
Debug.ShouldStop(2);
main._worship_place_address = BA.ObjectToString(_a.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("worship_place_address")))));
...
main.mostCurrent.__c.runVoidMethodAndSync ("Msgbox",(Object)(BA.ObjectToCharSequence("Wrong username or password")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Login Failed"))),main.mostCurrent.activityBA);
 ...
 BA.debugLineNum = 104;BA.debugLine="If (status = \"jamaah\") And (manager.GetBoole";
Debug.ShouldStop(128);
if (RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean("=",main._status,RemoteObject.createImmutable("jamaah"))))) && RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean("=",main._manager.runMethod(true,"GetBoolean",(Object)(RemoteObject.createImmutable("jamaah"))),main.mostCurrent.__c.getField(true,"True")))))) { 
...
main._manager.runVoidMethod ("SetString",(Object)(BA.ObjectToString("id")),(Object)(main._id));
 BA.debugLineNum = 107;BA.debugLine="Log(manager.GetString(\"username\"))";
Debug.ShouldStop(1024);
main.mostCurrent.__c.runVoidMethod ("Log",(Object)(main._manager.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("username")))));
 BA.debugLineNum = 108;BA.debugLine="Log(manager.GetString(\"id\"))";
Debug.ShouldStop(2048);
main.mostCurrent.__c.runVoidMethod ("Log",(Object)(main._manager.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("id")))));
 BA.debugLineNum = 109;BA.debugLine="Msgbox(\"login sebagai jamaah\",\"Info\")";
Debug.ShouldStop(4096);
...
main._manager.runVoidMethod ("SetBoolean",(Object)(BA.ObjectToString("is_login")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 111;BA.debugLine="Log(\"start home jamaah-----------------\")";
Debug.ShouldStop(16384);
main.mostCurrent.__c.runVoidMethod ("Log",(Object)(RemoteObject.createImmutable("start home jamaah-----------------")));
 BA.debugLineNum = 112;BA.debugLine="StartActivity(HomeJamaah)";
Debug.ShouldStop(32768);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((main.mostCurrent._homejamaah.getObject())));
 }else {
 BA.debugLineNum = 114;BA.debugLine="If (status = \"stewardship\") And (manager.Ge";
Debug.ShouldStop(131072);
if (RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean("=",main._status,RemoteObject.createImmutable("stewardship"))))) && RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean("=",main._manager.runMethod(true,"GetBoolean",(Object)(RemoteObject.createImmutable("step"))),main.mostCurrent.__c.getField(true,"True")))))) { 
 BA.debugLineNum = 115;BA.debugLine="Msgbox(\"login sebagai stewardship\",\"Info\")";
Debug.ShouldStop(262144);
main.mostCurrent.__c.runVoidMethodAndSync ("Msgbox",(Object)(BA.ObjectToCharSequence("login sebagai stewardship")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Info"))),main.mostCurrent.activityBA);
 BA.debugLineNum = 116;BA.debugLine="manager.SetString(\"username\",username)";
Debug.ShouldStop(524288);
main._manager.runVoidMethod ("SetString",(Object)(BA.ObjectToString("username")),(Object)(main._username));
 BA.debugLineNum = 117;BA.debugLine="manager.SetString(\"id\",id)";
Debug.ShouldStop(1048576);
main._manager.runVoidMethod ("SetString",(Object)(BA.ObjectToString("id")),(Object)(main._id));
 BA.debugLineNum = 118;BA.debugLine="Log(manager.GetString(\"username\"))";
Debug.ShouldStop(2097152);
main.mostCurrent.__c.runVoidMethod ("Log",(Object)(main._manager.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("username")))));
 BA.debugLineNum = 119;BA.debugLine="Log(manager.GetString(\"id\"))";
Debug.ShouldStop(4194304);
main.mostCurrent.__c.runVoidMethod ("Log",(Object)(main._manager.runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("id")))));
 BA.debugLineNum = 120;BA.debugLine="manager.SetBoolean(\"is_login\",True)";
Debug.ShouldStop(8388608);
main._manager.runVoidMethod ("SetBoolean",(Object)(BA.ObjectToString("is_login")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 121;BA.debugLine="Log(\"start home stewardship.............\")";
Debug.ShouldStop(16777216);
main.mostCurrent.__c.runVoidMethod ("Log",(Object)(RemoteObject.createImmutable("start home stewardship.............")));
 BA.debugLineNum = 122;BA.debugLine="StartActivity(HomeStewardship)";
Debug.ShouldStop(33554432);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((main.mostCurrent._homestewardship.getObject())));
 }else {
 BA.debugLineNum = 124;BA.debugLine="Msgbox(\"Pastikan Login Dengan Benar\",\"Warn";
Debug.ShouldStop(134217728);
main.mostCurrent.__c.runVoidMethodAndSync ("Msgbox",(Object)(BA.ObjectToCharSequence("Pastikan Login Dengan Benar")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Warning"))),main.mostCurrent.activityBA);
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e51.toString()); BA.debugLineNum = 130;BA.debugLine="Log(LastException)";
Debug.ShouldStop(2);
main.mostCurrent.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA))));
 BA.debugLineNum = 131;BA.debugLine="Msgbox(\"Wrong username or password\",\"Login Fa";
Debug.ShouldStop(4);
main.mostCurrent.__c.runVoidMethodAndSync ("Msgbox",(Object)(BA.ObjectToCharSequence("Wrong username or password")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Login Failed"))),main.mostCurrent.activityBA);
 };
 break; }
...
try {
		Debug.PushSubsStack("labeljam_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,195);
if (RapidSub.canDelegate("labeljam_click")) return b4a.example.main.remoteMe.runUserSub(false, "main","labeljam_click");
 BA.debugLineNum = 195;BA.debugLine="Sub labeljam_Click";
Debug.ShouldStop(4);
 BA.debugLineNum = 196;BA.debugLine="manager.SetBoolean(\"jamaah\",True)";
Debug.ShouldStop(8);
main._manager.runVoidMethod ("SetBoolean",(Object)(BA.ObjectToString("jamaah")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 197;BA.debugLine="manager.SetBoolean(\"step\",False)";
Debug.ShouldStop(16);
main._manager.runVoidMethod ("SetBoolean",(Object)(BA.ObjectToString("step")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 198;BA.debugLine="SetChecked(pstep,Labelstep,manager.GetBoolean(\"st";
Debug.ShouldStop(32);
_setchecked(main.mostCurrent._pstep,main.mostCurrent._labelstep,main._manager.runMethod(true,"GetBoolean",(Object)(RemoteObject.createImmutable("step"))));
 BA.debugLineNum = 199;BA.debugLine="SetChecked(pjam,labeljam,manager.GetBoolean(\"jama";
Debug.ShouldStop(64);
_setchecked(main.mostCurrent._pjam,main.mostCurrent._labeljam,main._manager.runMethod(true,"GetBoolean",(Object)(RemoteObject.createImmutable("jamaah"))));
...
try {
		Debug.PushSubsStack("Labelstep_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,188);
if (RapidSub.canDelegate("labelstep_click")) return b4a.example.main.remoteMe.runUserSub(false, "main","labelstep_click");
 BA.debugLineNum = 188;BA.debugLine="Sub Labelstep_Click";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 189;BA.debugLine="manager.SetBoolean(\"step\",True)";
Debug.ShouldStop(268435456);
main._manager.runVoidMethod ("SetBoolean",(Object)(BA.ObjectToString("step")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 190;BA.debugLine="manager.SetBoolean(\"jamaah\",False)";
Debug.ShouldStop(536870912);
main._manager.runVoidMethod ("SetBoolean",(Object)(BA.ObjectToString("jamaah")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 191;BA.debugLine="SetChecked(pstep,Labelstep,manager.GetBoolean(\"st";
Debug.ShouldStop(1073741824);
_setchecked(main.mostCurrent._pstep,main.mostCurrent._labelstep,main._manager.runMethod(true,"GetBoolean",(Object)(RemoteObject.createImmutable("step"))));
 BA.debugLineNum = 192;BA.debugLine="SetChecked(pjam,labeljam,manager.GetBoolean(\"jama";
Debug.ShouldStop(-2147483648);
_setchecked(main.mostCurrent._pjam,main.mostCurrent._labeljam,main._manager.runMethod(true,"GetBoolean",(Object)(RemoteObject.createImmutable("jamaah"))));
...
stewardshipdonationdetail_subs_0._process_globals();
donationjamaahdetail_subs_0._process_globals();
donationjamaahconfirm_subs_0._process_globals();
qurbanjamaahdetail_subs_0._process_globals();
qurbanjamaahconfirm_subs_0._process_globals();
...
stewardshipdonationdetail.myClass = BA.getDeviceClass ("b4a.example.stewardshipdonationdetail");
donationjamaahdetail.myClass = BA.getDeviceClass ("b4a.example.donationjamaahdetail");
donationjamaahconfirm.myClass = BA.getDeviceClass ("b4a.example.donationjamaahconfirm");
qurbanjamaahdetail.myClass = BA.getDeviceClass ("b4a.example.qurbanjamaahdetail");
qurbanjamaahconfirm.myClass = BA.getDeviceClass ("b4a.example.qurbanjamaahconfirm");
...
try {
		Debug.PushSubsStack("SetChecked (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,157);
...
Debug.locals.put("PressedState", _pressedstate);
 BA.debugLineNum = 157;BA.debugLine="Sub SetChecked(v As Panel,s As Label, PressedState";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 158;BA.debugLine="Dim checked, unchecked As ColorDrawable";
Debug.ShouldStop(536870912);
...
_unchecked = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.ColorDrawable");Debug.locals.put("unchecked", _unchecked);
 BA.debugLineNum = 159;BA.debugLine="checked.Initialize(Colors.ARGB(255,5,138,72), 0di";
Debug.ShouldStop(1073741824);
_checked.runVoidMethod ("Initialize",(Object)(main.mostCurrent.__c.getField(false,"Colors").runMethod(true,"ARGB",(Object)(BA.numberCast(int.class, 255)),(Object)(BA.numberCast(int.class, 5)),(Object)(BA.numberCast(int.class, 138)),(Object)(BA.numberCast(int.class, 72)))),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0)))));
 BA.debugLineNum = 160;BA.debugLine="unchecked.Initialize(Colors.White, 0dip)";
Debug.ShouldStop(-2147483648);
_unchecked.runVoidMethod ("Initialize",(Object)(main.mostCurrent.__c.getField(false,"Colors").getField(true,"White")),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0)))));
 BA.debugLineNum = 161;BA.debugLine="Log(PressedState)";
Debug.ShouldStop(1);
main.mostCurrent.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(_pressedstate)));
 BA.debugLineNum = 162;BA.debugLine="Select PressedState";
Debug.ShouldStop(2);
...
case 0: {
 BA.debugLineNum = 164;BA.debugLine="v.Background = checked";
Debug.ShouldStop(8);
_v.runMethod(false,"setBackground",(_checked.getObject()));
 BA.debugLineNum = 165;BA.debugLine="s.TextColor = Colors.White";
Debug.ShouldStop(16);
_s.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 break; }
case 1: {
 BA.debugLineNum = 167;BA.debugLine="v.Background = unchecked";
Debug.ShouldStop(64);
_v.runMethod(false,"setBackground",(_unchecked.getObject()));
 BA.debugLineNum = 168;BA.debugLine="s.TextColor = Colors.Black";
Debug.ShouldStop(128);
