...
public static b4a.example.poorjamaah _poorjamaah = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",orphansjamaah.mostCurrent._activity,"Address",orphansjamaah.mostCurrent._address,"BtnDonationHere",orphansjamaah.mostCurrent._btndonationhere,"CLV",orphansjamaah.mostCurrent._clv,"CodeSemua",Debug.moduleToString(b4a.example.codesemua.class),"DonationJamaah",Debug.moduleToString(b4a.example.donationjamaah.class),"DonationJamaahConfirm",Debug.moduleToString(b4a.example.donationjamaahconfirm.class),"DonationJamaahDetail",Debug.moduleToString(b4a.example.donationjamaahdetail.class),"fund",orphansjamaah._fund,"HistoryJamaah",Debug.moduleToString(b4a.example.historyjamaah.class),"HomeJamaah",Debug.moduleToString(b4a.example.homejamaah.class),"HomeStewardship",Debug.moduleToString(b4a.example.homestewardship.class),"HttpUtils2Service",orphansjamaah.mostCurrent._httputils2service,"id",orphansjamaah._id,"id_clicked",orphansjamaah._id_clicked,"IDpro",orphansjamaah.mostCurrent._idpro,"Main",Debug.moduleToString(b4a.example.main.class),"MainScroll",orphansjamaah.mostCurrent._mainscroll,"MapsJamaah",Debug.moduleToString(b4a.example.mapsjamaah.class),"MosqueName",orphansjamaah.mostCurrent._mosquename,"name_project",orphansjamaah._name_project,"NavbarTitle",orphansjamaah.mostCurrent._navbartitle,"OrphansJamaahDetail",Debug.moduleToString(b4a.example.orphansjamaahdetail.class),"PanelListItem",orphansjamaah.mostCurrent._panellistitem,"PanelQurban",orphansjamaah.mostCurrent._panelqurban,"PoorJamaah",Debug.moduleToString(b4a.example.poorjamaah.class),"PoorJamaahDetail",Debug.moduleToString(b4a.example.poorjamaahdetail.class),"QurbanJamaah",Debug.moduleToString(b4a.example.qurbanjamaah.class),"QurbanJamaahConfirm",Debug.moduleToString(b4a.example.qurbanjamaahconfirm.class),"QurbanJamaahDetail",Debug.moduleToString(b4a.example.qurbanjamaahdetail.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"Status",orphansjamaah.mostCurrent._status,"StewardshipDonationDetail",Debug.moduleToString(b4a.example.stewardshipdonationdetail.class),"TpaJamaah",Debug.moduleToString(b4a.example.tpajamaah.class),"TpaJamaahDetail",Debug.moduleToString(b4a.example.tpajamaahdetail.class),"xui",orphansjamaah._xui};
}
}