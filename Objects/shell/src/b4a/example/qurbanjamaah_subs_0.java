...
try {
		Debug.PushSubsStack("Activity_Create (qurbanjamaah) ","qurbanjamaah",6,qurbanjamaah.mostCurrent.activityBA,qurbanjamaah.mostCurrent,28);
...
qurbanjamaah.mostCurrent._navbartitle.runMethod(true,"setText",BA.ObjectToCharSequence("Qurban"));
 BA.debugLineNum = 35;BA.debugLine="NavbarTitle.TextSize = 22";
Debug.ShouldStop(4);
qurbanjamaah.mostCurrent._navbartitle.runMethod(true,"setTextSize",BA.numberCast(float.class, 22));
...
try {
		Debug.PushSubsStack("Activity_Pause (qurbanjamaah) ","qurbanjamaah",6,qurbanjamaah.mostCurrent.activityBA,qurbanjamaah.mostCurrent,45);
...
try {
		Debug.PushSubsStack("Activity_Resume (qurbanjamaah) ","qurbanjamaah",6,qurbanjamaah.mostCurrent.activityBA,qurbanjamaah.mostCurrent,39);
...
try {
		Debug.PushSubsStack("CLV_ItemClick (qurbanjamaah) ","qurbanjamaah",6,qurbanjamaah.mostCurrent.activityBA,qurbanjamaah.mostCurrent,104);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 104;BA.debugLine="Sub CLV_ItemClick (Index As Int, Value As Object)";
Debug.ShouldStop(128);
...
try {
		Debug.PushSubsStack("CreateItem (qurbanjamaah) ","qurbanjamaah",6,qurbanjamaah.mostCurrent.activityBA,qurbanjamaah.mostCurrent,49);
...
try {
		Debug.PushSubsStack("JobDone (qurbanjamaah) ","qurbanjamaah",6,qurbanjamaah.mostCurrent.activityBA,qurbanjamaah.mostCurrent,62);
...
if (RemoteObject.solveBoolean(">",RemoteObject.solve(new RemoteObject[] {_data.runMethod(true,"getSize"),RemoteObject.createImmutable(1)}, "-",1, 1),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 74;BA.debugLine="For i=0 To data.Size -1";
Debug.ShouldStop(512);
{
final int step12 = 1;
...
_a = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("a", _a);
 BA.debugLineNum = 76;BA.debugLine="Dim animal As List";
Debug.ShouldStop(2048);
_animal = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("animal", _animal);
 BA.debugLineNum = 78;BA.debugLine="a = data.Get(i)";
Debug.ShouldStop(8192);
_a.setObject(_data.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))));
 BA.debugLineNum = 79;BA.debugLine="animal = a.Get(\"animal_type\")";
Debug.ShouldStop(16384);
_animal.setObject(_a.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("animal_type")))));
 BA.debugLineNum = 81;BA.debugLine="If animal.Size <> 0 Then";
Debug.ShouldStop(65536);
if (RemoteObject.solveBoolean("!",_animal.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 82;BA.debugLine="CLV.Add(CreateItem(CLV.AsView.Width,a.Get(";
Debug.ShouldStop(131072);
qurbanjamaah.mostCurrent._clv.runVoidMethod ("_add",RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _createitem(qurbanjamaah.mostCurrent._clv.runMethod(false,"_asview").runMethod(true,"getWidth"),BA.ObjectToString(_a.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("id"))))),RemoteObject.concat(RemoteObject.createImmutable("Qurban "),_a.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("name"))))),RemoteObject.createImmutable("Qurban Available")).getObject()),(Object)((RemoteObject.createImmutable(""))));
 BA.debugLineNum = 83;BA.debugLine="CLV.AsView.Height = (PanelListItem.Height+";
Debug.ShouldStop(262144);
...
;
 BA.debugLineNum = 86;BA.debugLine="PanelQurban.Height= CLV.AsView.Height + 10%y";
Debug.ShouldStop(2097152);
qurbanjamaah.mostCurrent._panelqurban.runMethod(true,"setHeight",RemoteObject.solve(new RemoteObject[] {qurbanjamaah.mostCurrent._clv.runMethod(false,"_asview").runMethod(true,"getHeight"),qurbanjamaah.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 10)),qurbanjamaah.mostCurrent.activityBA)}, "+",1, 1));
 BA.debugLineNum = 87;BA.debugLine="CLV.sv.Height = CLV.AsView.Height";
Debug.ShouldStop(4194304);
qurbanjamaah.mostCurrent._clv.getField(false,"_sv").runMethod(true,"setHeight",qurbanjamaah.mostCurrent._clv.runMethod(false,"_asview").runMethod(true,"getHeight"));
 BA.debugLineNum = 88;BA.debugLine="CLV.AsView.Height = CLV.AsView.Height";
Debug.ShouldStop(8388608);
qurbanjamaah.mostCurrent._clv.runMethod(false,"_asview").runMethod(true,"setHeight",qurbanjamaah.mostCurrent._clv.runMethod(false,"_asview").runMethod(true,"getHeight"));
 BA.debugLineNum = 89;BA.debugLine="MainScroll.Panel.Height = PanelQurban.Height";
...
qurbanjamaah.mostCurrent._mainscroll.runMethod(false,"getPanel").runMethod(true,"setHeight",qurbanjamaah.mostCurrent._panelqurban.runMethod(true,"getHeight"));
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",qurbanjamaah.processBA, e28.toString()); BA.debugLineNum = 93;BA.debugLine="Log(LastException)";
...
;
 ...
 BA.debugLineNum = 98;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
Debug.ShouldStop(2);
qurbanjamaah.mostCurrent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage"))));
 BA.debugLineNum = 99;BA.debugLine="ToastMessageShow(\"Error: \" & Job.ErrorMessage, T";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("PanelListItem_Click (qurbanjamaah) ","qurbanjamaah",6,qurbanjamaah.mostCurrent.activityBA,qurbanjamaah.mostCurrent,108);
...
RemoteObject _a = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
 BA.debugLineNum = 108;BA.debugLine="Sub PanelListItem_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 109;BA.debugLine="Dim item As Int = CLV.GetItemFromView(Sender)";
Debug.ShouldStop(4096);
...
qurbanjamaah._idselected = _a.runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 0))).runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 4))).runMethod(true,"getText");
 BA.debugLineNum = 122;BA.debugLine="Log(idSelected)";
Debug.ShouldStop(33554432);
qurbanjamaah.mostCurrent.__c.runVoidMethod ("Log",(Object)(qurbanjamaah._idselected));
 BA.debugLineNum = 123;BA.debugLine="StartActivity(QurbanJamaahDetail)";
