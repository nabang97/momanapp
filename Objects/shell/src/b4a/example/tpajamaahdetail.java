...
public static b4a.example.poorjamaah _poorjamaah = null;
  public Object[] GetGlobals() {
		return new Object[] {"account",tpajamaahdetail.mostCurrent._account,"accountId",tpajamaahdetail.mostCurrent._accountid,"Activity",tpajamaahdetail.mostCurrent._activity,"Button1",tpajamaahdetail.mostCurrent._button1,"CheckGuna",tpajamaahdetail.mostCurrent._checkguna,"CheckHamba",tpajamaahdetail.mostCurrent._checkhamba,"CodeSemua",Debug.moduleToString(b4a.example.codesemua.class),"DonationJamaah",Debug.moduleToString(b4a.example.donationjamaah.class),"DonationJamaahConfirm",Debug.moduleToString(b4a.example.donationjamaahconfirm.class),"DonationJamaahDetail",Debug.moduleToString(b4a.example.donationjamaahdetail.class),"EditTotal",tpajamaahdetail.mostCurrent._edittotal,"HistoryJamaah",Debug.moduleToString(b4a.example.historyjamaah.class),"HomeJamaah",Debug.moduleToString(b4a.example.homejamaah.class),"HomeStewardship",Debug.moduleToString(b4a.example.homestewardship.class),"HttpUtils2Service",tpajamaahdetail.mostCurrent._httputils2service,"Main",Debug.moduleToString(b4a.example.main.class),"MainScroll",tpajamaahdetail.mostCurrent._mainscroll,"MapsJamaah",Debug.moduleToString(b4a.example.mapsjamaah.class),"NavbarTitle",tpajamaahdetail.mostCurrent._navbartitle,"noTransaction",tpajamaahdetail.mostCurrent._notransaction,"OrphansJamaah",Debug.moduleToString(b4a.example.orphansjamaah.class),"OrphansJamaahDetail",Debug.moduleToString(b4a.example.orphansjamaahdetail.class),"PanelQurban",tpajamaahdetail.mostCurrent._panelqurban,"pengurus",tpajamaahdetail.mostCurrent._pengurus,"PoorJamaah",Debug.moduleToString(b4a.example.poorjamaah.class),"PoorJamaahDetail",Debug.moduleToString(b4a.example.poorjamaahdetail.class),"publicId",tpajamaahdetail.mostCurrent._publicid,"QurbanJamaah",Debug.moduleToString(b4a.example.qurbanjamaah.class),"QurbanJamaahConfirm",Debug.moduleToString(b4a.example.qurbanjamaahconfirm.class),"QurbanJamaahDetail",Debug.moduleToString(b4a.example.qurbanjamaahdetail.class),"SpinPengurus",tpajamaahdetail.mostCurrent._spinpengurus,"Starter",Debug.moduleToString(b4a.example.starter.class),"StewardshipDonationDetail",Debug.moduleToString(b4a.example.stewardshipdonationdetail.class),"TpaJamaah",Debug.moduleToString(b4a.example.tpajamaah.class)};
}
}