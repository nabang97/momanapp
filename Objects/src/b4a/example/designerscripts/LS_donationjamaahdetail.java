...
views.get("horizontalscrollview1").vw.setHeight((int)((40d / 100 * width)));
...
views.get("horizontalscrollview1").vw.setTop((int)((2d / 100 * height)));
views.get("fundneeded").vw.setTop((int)((views.get("horizontalscrollview1").vw.getTop())+(views.get("horizontalscrollview1").vw.getHeight())+(2d / 100 * height)));
views.get("fundcollected").vw.setTop((int)((views.get("fundneeded").vw.getTop())+(views.get("fundneeded").vw.getHeight())));
views.get("progress").vw.setTop((int)((views.get("fundcollected").vw.getTop())+(views.get("fundcollected").vw.getHeight())));
