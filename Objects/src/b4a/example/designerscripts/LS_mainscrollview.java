...
views.get("backbtn").vw.setTop((int)((3.5d / 100 * height)));
views.get("backbtn").vw.setHeight((int)((6.5d / 100 * height) - ((3.5d / 100 * height))));
...
views.get("navbartitle").vw.setHeight((int)((10d / 100 * height) - ((0d / 100 * height))));
