...
vis = vis | (stewardshipdonationdetail.mostCurrent != null);
vis = vis | (donationjamaahdetail.mostCurrent != null);
vis = vis | (donationjamaahconfirm.mostCurrent != null);
vis = vis | (qurbanjamaahdetail.mostCurrent != null);
vis = vis | (qurbanjamaahconfirm.mostCurrent != null);
...
BA.applicationContext.stopService(new android.content.Intent(BA.applicationContext, starter.class));
 ...
 {
            Activity __a = null;
            if (stewardshipdonationdetail.previousOne != null) {
				__a = stewardshipdonationdetail.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(stewardshipdonationdetail.mostCurrent == null ? null : stewardshipdonationdetail.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
 ...
 {
            Activity __a = null;
            if (donationjamaahconfirm.previousOne != null) {
				__a = donationjamaahconfirm.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(donationjamaahconfirm.mostCurrent == null ? null : donationjamaahconfirm.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
 ...
 {
            Activity __a = null;
            if (qurbanjamaahconfirm.previousOne != null) {
				__a = qurbanjamaahconfirm.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(qurbanjamaahconfirm.mostCurrent == null ? null : qurbanjamaahconfirm.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
...
RDebugUtils.currentLine=786443;
 //BA.debugLineNum = 786443;BA.debugLine="CodeSemua.ExecuteUrl(server&\"api/login\",\"phone=\"&";
mostCurrent._codesemua._executeurl(mostCurrent.activityBA,_server+"api/login","phone="+mostCurrent._editusername.getText()+"&password="+mostCurrent._md5string,"Login",main.getObject());
...
RDebugUtils.currentLine=720913;
 //BA.debugLineNum = 720913;BA.debugLine="worship_name = a.Get(\"worship_name\")";
_worship_name = BA.ObjectToString(_a.Get((Object)("worship_name")));
RDebugUtils.currentLine=720914;
 //BA.debugLineNum = 720914;BA.debugLine="types= a.Get(\"types\")";
_types = BA.ObjectToString(_a.Get((Object)("types")));
...
RDebugUtils.currentLine=720916;
 //BA.debugLineNum = 720916;BA.debugLine="updated_at= a.Get(\"updated_at\")";
_updated_at = BA.ObjectToString(_a.Get((Object)("updated_at")));
...
RDebugUtils.currentLine=720918;
 //BA.debugLineNum = 720918;BA.debugLine="worship_place_address= a.Get(\"worship_place_a";
_worship_place_address = BA.ObjectToString(_a.Get((Object)("worship_place_address")));
...
RDebugUtils.currentLine=720924;
 //BA.debugLineNum = 720924;BA.debugLine="If (status = \"jamaah\") And (manager.GetBoole";
if (((_status).equals("jamaah")) && (_manager.GetBoolean("jamaah")==anywheresoftware.b4a.keywords.Common.True)) { 
...
RDebugUtils.currentLine=720927;
 //BA.debugLineNum = 720927;BA.debugLine="Log(manager.GetString(\"username\"))";
anywheresoftware.b4a.keywords.Common.Log(_manager.GetString("username"));
RDebugUtils.currentLine=720928;
 //BA.debugLineNum = 720928;BA.debugLine="Log(manager.GetString(\"id\"))";
anywheresoftware.b4a.keywords.Common.Log(_manager.GetString("id"));
RDebugUtils.currentLine=720929;
 //BA.debugLineNum = 720929;BA.debugLine="Msgbox(\"login sebagai jamaah\",\"Info\")";
...
RDebugUtils.currentLine=720930;
 //BA.debugLineNum = 720930;BA.debugLine="manager.SetBoolean(\"is_login\",True)";
_manager.SetBoolean("is_login",anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=720931;
 //BA.debugLineNum = 720931;BA.debugLine="Log(\"start home jamaah-----------------\")";
anywheresoftware.b4a.keywords.Common.Log("start home jamaah-----------------");
RDebugUtils.currentLine=720932;
 //BA.debugLineNum = 720932;BA.debugLine="StartActivity(HomeJamaah)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._homejamaah.getObject()));
 }else {
RDebugUtils.currentLine=720934;
 //BA.debugLineNum = 720934;BA.debugLine="If (status = \"stewardship\") And (manager.Ge";
...
RDebugUtils.currentLine=720935;
 //BA.debugLineNum = 720935;BA.debugLine="Msgbox(\"login sebagai stewardship\",\"Info\")";
...
RDebugUtils.currentLine=720936;
 //BA.debugLineNum = 720936;BA.debugLine="manager.SetString(\"username\",username)";
_manager.SetString("username",_username);
RDebugUtils.currentLine=720937;
 //BA.debugLineNum = 720937;BA.debugLine="manager.SetString(\"id\",id)";
_manager.SetString("id",_id);
RDebugUtils.currentLine=720938;
 //BA.debugLineNum = 720938;BA.debugLine="Log(manager.GetString(\"username\"))";
anywheresoftware.b4a.keywords.Common.Log(_manager.GetString("username"));
RDebugUtils.currentLine=720939;
 //BA.debugLineNum = 720939;BA.debugLine="Log(manager.GetString(\"id\"))";
anywheresoftware.b4a.keywords.Common.Log(_manager.GetString("id"));
RDebugUtils.currentLine=720940;
 //BA.debugLineNum = 720940;BA.debugLine="manager.SetBoolean(\"is_login\",True)";
_manager.SetBoolean("is_login",anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=720941;
 //BA.debugLineNum = 720941;BA.debugLine="Log(\"start home stewardship.............\")";
anywheresoftware.b4a.keywords.Common.Log("start home stewardship.............");
RDebugUtils.currentLine=720942;
 //BA.debugLineNum = 720942;BA.debugLine="StartActivity(HomeStewardship)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._homestewardship.getObject()));
 }else {
RDebugUtils.currentLine=720944;
 //BA.debugLineNum = 720944;BA.debugLine="Msgbox(\"Pastikan Login Dengan Benar\",\"Warn";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Pastikan Login Dengan Benar"),BA.ObjectToCharSequence("Warning"),mostCurrent.activityBA);
			...
			processBA.setLastException(e51);RDebugUtils.currentLine=720950;
 //BA.debugLineNum = 720950;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)));
RDebugUtils.currentLine=720951;
 //BA.debugLineNum = 720951;BA.debugLine="Msgbox(\"Wrong username or password\",\"Login Fa";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Wrong username or password"),BA.ObjectToCharSequence("Login Failed"),mostCurrent.activityBA);
 };
 break; }
}
...
RDebugUtils.currentLine=720955;
 //BA.debugLineNum = 720955;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
anywheresoftware.b4a.keywords.Common.Log("Error: "+_job._errormessage);
RDebugUtils.currentLine=720956;
 //BA.debugLineNum = 720956;BA.debugLine="ToastMessageShow(\"Error: \" & Job.ErrorMessage, T";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Error: "+_job._errormessage),anywheresoftware.b4a.keywords.Common.True);
 };
RDebugUtils.currentLine=720958;
 //BA.debugLineNum = 720958;BA.debugLine="Job.Release";
_job._release();
RDebugUtils.currentLine=720959;
 //BA.debugLineNum = 720959;BA.debugLine="End Sub";
return "";
}
